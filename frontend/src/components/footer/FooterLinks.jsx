    ...
    return (
        <>
            <div className=" bg-black py-15">
                <div className='grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-8 w-[90%] m-auto'>
                    <div className='lg:w-full md:w-[50%] w-[80%] flex flex-col items-center mx-auto md:mx-0 md:items-start'>
                        <img src={logo} alt="" />
                        <p className='text-white my-5 w-full text-center md:text-left'>The home and elements needed to create beautiful products</p>
            ...
            <div className='bg-black pb-10'>
                <div className='flex md:flex-row flex-col gap-8 items-center md:items-start justify-between w-[80%] m-auto'>
